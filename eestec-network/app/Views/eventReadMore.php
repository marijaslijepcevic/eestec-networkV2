            ...
            <div class='artikal col-sm-11'>  <!--artikal treba da bude resizable-->
                <div class='lc container' >
                    ...
                    <div class="row-cols-1">
                        <?php if($op == 1) : ?>
                            <a href='<?= site_url("Admin/acceptEvents")?>'><button class = 'dugme'  type='button' name='acc' value = '<?php echo $event->IdEvent?>'>Back</button></a>
                         <?php endif; ?>
                        <?php  if($op ==2) : ?>
                            <a href='<?= site_url("Admin/deleteEvents")?>'><button class = 'dugme'  type='button' name='acc' value = '<?php echo $event->IdEvent?>'>Back</button></a>    
                        <?php endif; ?>
                        <?php  if($op ==3) : ?>
                            <a href='<?= site_url("LocalCommittee/viewEvents")?>'><button class = 'dugme'  type='button' name='acc' value = '<?php echo $event->IdEvent?>'>Back</button></a>    
                         <?php endif; ?>
